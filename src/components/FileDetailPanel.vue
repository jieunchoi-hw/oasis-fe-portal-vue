<template>
  ...
  >
    <div
      v-if="isVisible"
      class="fixed right-0 bg-white z-50 transform transition-transform border-l"
      style="
        width: 500px;
        top: 4rem;
    ...
    >
      ...
      <!-- 제목 -->
      <div class="px-9 py-6">
        <h2 class="text-gray-900 font-bold text-xl leading-7">
          구매 관리 규정
        </h2>
      </div>
      ...
      <div class="px-9 overflow-y-auto" style="height: calc(100% - 244px)">
        <div class="text-gray-900 leading-5">
          ...
          <p class="mb-4">
            ...
            이 규정은 회사의 구매 활동에 관한 기준과 절차를 정하여 비용 절감,
            품질 확보, 투명한 거래질서를 확립함을 목적으로 한다.
          </p>
