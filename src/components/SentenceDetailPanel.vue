<template>
  ...
  >
    <div
      v-if="isVisible"
      class="fixed right-0 top-0 bg-white z-50 transform transition-transform border-l w-[800px] h-screen border-gray-200 flex flex-col"
    >
          <!-- 헤더 -->
          <div
          ...
          <div class="flex-1 overflow-y-auto min-h-0">
            ...
            <div class="flex px-9 gap-2.5 flex-1">
              <!-- 왼쪽 텍스트 영역 -->
              <div
                class="bg-white border border-gray-300 rounded-xl p-5 overflow-y-auto w-[728px] min-h-[300px]"
              >
                <div class="text-gray-900 text-sm font-medium leading-tight">
                  ...
                  <p class="mb-4">
                    ...
                    이 규정은 회사의 모든 부서가 수행하는 자재, 용역, 서비스 및
                    기타 구매 행위에 적용한다.
                  </p>

                  <p class="mb-6">
                    <strong>제3조 (용어 정의)</strong><br />
                    구매라 함은 회사 운영에 필요한 물품, 서비스, 자산 등을
                    외부에서 조달하는 행위를 말한다.<br />
                  ...
                  <p class="mb-4">
                    ...
                    승인을 득해야 한다.<br />
                    요청서에는 품명, 규격, 수량, 필요 시기, 예산 코드 등을
                    명시한다.
                  </p>

                  <p class="mb-4">
                    <strong>제5조 (구매 검토 및 승인)</strong><br />
                    구매 요청은 예산 범위 내에서 집행되어야 하며, 예산 외 구매
                    시 대표이사 승인을 받아야 한다.<br />
            ...
            <div class="px-9 pb-2 pt-8">
              <div class="flex flex-col gap-2">
                ...
                >
                  <!-- 링크 제목 입력 -->
                  <div
                    class="flex items-center border border-gray-300 rounded-lg px-3 w-[280px] h-12"
                  >
                    <input
                      v-model="link.title"
                      type="text"
